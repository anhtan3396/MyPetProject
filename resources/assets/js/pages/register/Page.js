...
class Page extends React.Component {
    constructor(props) {
        ...
        this.validator = new ReeValidate({
            ...
            //mà ko phải chuyện này bên serve làm à. cảm thấy bên view check required hay min mã là đủ rồi :v
        });
        ...
        this.validationRePassword = this.validationRePassword.bind(this);
    ...
    validationRePassword(){
        const { password, password_confirmation } = this.state.credentials;
         const { errors } = this.validator;
